    ...
    if (!connected) {
      return (
        <div className="relative inline-flex items-center justify-center group">
          ...
          <WalletMultiButton className="!bg-black !border-transparent !rounded-full !px-7 !py-2 !text-base !font-normal hover:!bg-gray-900 transition-all duration-200" />
        </div>
      );
    }

    // Connected state with profile dropdown
    return (
          ...
          >
            ...
            <div className="border-t border-gray-700/50 pt-2">
              <button 
                ...
                className="group w-full flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-900/20 transition-all duration-200 transform hover:translate-x-1"
              >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div ref={panelRef} className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${open ? "max-h-screen border-t border-gray-800/50 pt-4 pb-4" : "max-h-0"}`}>
            <div className="space-y-4">
              ...
              <div className="px-3">
                  {!connected ? (
                    <WalletMultiButton className="!w-full !px-6 !py-3 !bg-gradient-to-r !from-blue-600 !to-purple-600 hover:!from-blue-700 hover:!to-purple-700 !text-white !text-sm !font-medium !rounded-xl !transition-all !duration-200" />
                  ) : (
                    <div className="space-y-3">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between">
                                ...
                                <button onClick={() => copyToClipboard(publicKey.toString())} className="p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors" title="Copy address">
                      ...
                      <div className="bg-gray-900/50 border border-gray-800 rounded-lg overflow-hidden">
                        ...
                        <button onClick={() => { disconnect(); setOpen(false); }} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-400 hover:text-red-300 hover:bg-red-900/20 transition-colors">
