...
import { FastProfile } from "./components/FastProfile";
import { FastTickets } from "./components/FastTickets";
  ...
  return (
    <Routes>
      ...
      <Route path="/dashboard" element={<OrganizerDashboard />}>
        <Route index element={<FastDashboard />} />
        <Route path="profile" element={<FastProfile />} />
        <Route path="tickets" element={<FastTickets />} />
